...
namespace ZX_sharp.Hardware.Z80_CPU
{
    public class Z80
    {
        ...
        public Z80(RAM memory, IPorts ports)
        {
        ...
        public void Parse()
        {
            ...
            {
                var stack = Sp;
                mem.Write(--stack, (byte)(Pc >> 8));
                mem.Write(--stack ,(byte)(Pc));
                    ...
                    case 2:
                        {
                            ...
                            registers[PC] = mem.Read(address++);
                            registers[PC + 1] = mem.Read(address);
#if (DEBUG)
                            Log("MI 2");
#endif
                            Wait(17);
            ...
            if (hi == 1)
            {
                ...
                var reg = useHL2 ? mem.Read(Hl) : registers[lo];
            ...
            switch (mc)
            {
                ...
                case 0x2A:
                    {
                        // LD HL, (nn) 
                        var addr = Fetch16();
                        registers[L] = mem.Read(addr++);
                        registers[H] = mem.Read(addr);
#if (DEBUG)
                ...
                case 0x22:
                    {
                        // LD (nn), HL
                        var addr = Fetch16();
                        mem.Write(addr++, registers[L]);
                        mem.Write(addr,registers[H]);
#if (DEBUG)
                ...
                case 0xC5:
                    {
                        // PUSH BC
                        var addr = Sp;
                        mem.Write(--addr, registers[B]);
                        mem.Write(--addr, registers[C]);
                ...
                case 0xD5:
                    {
                        // PUSH DE
                        var addr = Sp;
                        mem.Write(--addr, registers[D]);
                        mem.Write(--addr, registers[E]);
                        registers[SP + 1] = (byte)(addr & 0xFF);
                        registers[SP] = (byte)(addr >> 8);
#if (DEBUG)
                        Log("PUSH DE");
                ...
                case 0xC1:
                    {
                        // POP BC
                        var addr = Sp;
                        registers[C] = mem.Read( addr++);
                        registers[B] = mem.Read(addr++);
                        registers[SP + 1] = (byte)(addr & 0xFF);
                        registers[SP] = (byte)(addr >> 8);
#if (DEBUG)
                        Log("POP BC");
                ...
                case 0xD1:
                    {
                        // POP DE
                        var addr = Sp;
                        registers[E] = mem.Read(addr++);
                        registers[D] = mem.Read(addr++);
                        registers[SP + 1] = (byte)(addr & 0xFF);
                        registers[SP] = (byte)(addr >> 8);
#if (DEBUG)
                        Log("POP DE");
                ...
                case 0xC9:
                    {
                        var stack = Sp;
                        registers[PC + 1] = mem.Read(stack++);
                        registers[PC] = mem.Read(stack++);
                        registers[SP] = (byte)(stack >> 8);
                        registers[SP + 1] = (byte)(stack);
#if (DEBUG)
                        Log("RET");
        ...
        private void ParseCB(byte mode = 0)
        {
            ...
            var useIX = mode == 0xDD;
            var useIY = mode == 0XFD;
            var reg = useHL ? useIX ? mem.Read((ushort)(Ix + d)) : useIY ? mem.Read((ushort)(Iy + d)) :
                mem.Read(Hl) : registers[lo];
#if (DEBUG)
            string debug_target;
            if (useHL)
            ...
            if (useHL)
            {
                if (useIX)
                {
                    mem.Write((ushort)(Ix + d),reg);
                    Wait(23);
                }
                else if (useIY)
                {
                    mem.Write((ushort)(Iy + d),reg);
                    Wait(23);
                }
                else
                {
                ...
                case 0x7B:
                    {
                        // LD SP, (nn)
                        var addr = Fetch16();
                        registers[SP + 1] = mem.Read(addr++);
                        registers[SP] = mem.Read(addr);
#if (DEBUG)
                ...
                case 0x73:
                    {
                        // LD (nn), SP
                        var addr = Fetch16();
                        mem.Write(addr++, registers[SP + 1]);
                        mem.Write(addr, registers[SP]);
#if (DEBUG)
                ...
                case 0x7e:
                    {
                        // LD r, (IX+d)
                        var d = (sbyte)Fetch();
                        registers[mid] = mem.Read((ushort)(Ix + d));
#if (DEBUG)
                ...
                case 0x77:
                    {
                        // LD (IX+d), r
                        var d = (sbyte)Fetch();
                        mem.Write((ushort)(Ix + d), registers[lo]);
#if (DEBUG)
                ...
                case 0x2A:
                    {
                        // LD IX, (nn)
                        var addr = Fetch16();
                        registers[IX + 1] = mem.Read(addr++);
                        registers[IX] = mem.Read(addr);
#if (DEBUG)
                ...
                case 0x22:
                    {
                        // LD (nn), IX
                        var addr = Fetch16();
                        mem.Write(addr++,registers[IX + 1]);
                        mem.Write(addr, registers[IX]);
#if (DEBUG)
                ...
                case 0x34:
                    {
                        // INC (IX+d)
                        var d = (sbyte)Fetch();
                        mem.Write((ushort)(Ix + d) ,Inc(mem.Read((ushort)(Ix + d))));
#if (DEBUG)
                        Log($"INC (IX{d:+0;-#})");
#endif
                        Wait(7);
                ...
                case 0x35:
                    {
                        // DEC (IX+d)
                        var d = (sbyte)Fetch();
                        mem.Write((ushort)(Ix + d), Dec(mem.Read((ushort)(Ix + d))));
#if (DEBUG)
                        Log($"DEC (IX{d:+0;-#})");
#endif
                        Wait(7);
                ...
                case 0x7e:
                    {
                        // LD r, (IY+d)
                        var d = (sbyte)Fetch();
                        registers[r] = mem.Read((ushort)(Iy + d));
#if (DEBUG)
                ...
                case 0x77:
                    {
                        // LD (IY+d), r
                        var d = (sbyte)Fetch();
                        mem.Write((ushort)(Iy + d), registers[lo]);
#if (DEBUG)
                ...
                case 0x2A:
                    {
                        // LD IY, (nn)
                        var addr = Fetch16();
                        registers[IY + 1] = mem.Read(addr++);
                        registers[IY] = mem.Read(addr);
#if (DEBUG)
                ...
                case 0x22:
                    {
                        // LD (nn), IY
                        var addr = Fetch16();
                        mem.Write(addr++, registers[IY + 1]);
                        mem.Write(addr, registers[IY]);
#if (DEBUG)
                ...
                case 0x34:
                    {
                        // INC (IY+d)
                        var d = (sbyte)Fetch();
                        mem.Write((ushort)(Iy + d),Inc(mem.Read((ushort)(Iy + d))));
#if (DEBUG)
                        Log($"INC (IY{d:+0;-#})");
#endif
                        Wait(7);
                ...
                case 0x35:
                    {
                        // DEC (IY+d)
                        var d = (sbyte)Fetch();
                        mem.Write((ushort)(Iy + d), Dec(mem.Read((ushort)(Iy + d))));
#if (DEBUG)
                        Log($"DEC (IY{d:+0;-#})");
#endif
                        Wait(7);
